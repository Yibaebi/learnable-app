  ...
  render() {
    ...
    return (
      <div className="learnable-app-page">
        ...
        <main className="learnable-homepage mobile-hidden">
        ...
        <main className="learnable-homepage desktop-hidden">
          <section id="notification">
            <div id="notification-main">
              <img src={require("../../../Icons/clear_24px.png")} alt="clear notification" />
              <div id="notification-1">
                <h4>Coming soon: Learnable ‘20</h4>
                <p>
                  We've started taking in applications for the next batch of
          ...
          <div id="hero">
            ...
            <section className="learnable-hero-media">
              ...
              <aside id="learnable-hero-media">
                <img
                  src={require("../../../Mobile Images/Video.png")}
                  alt="genesys opportunity image"
                />
              </aside>
              <aside id="hero-statistics">
          ...
          <section className="main-subsection-container-learning">
            <div>
              <img
                src={require("../../../Mobile Images/Mobile - Learnable Home/Photo-2.png")}
                alt={alt[0]}
              />
            </div>
            <div className="main-subsection-learning">
              <h3>{header[0]}</h3>
              <p>{text[0]}</p>
              <p>{text[1]}</p>
            </div>
          </section>
          <section className=" build-software" id="white-bg">
            <div id="build-software-1">
              <p>For Developers</p>
              <h3>Learn to Build Software the Right Way</h3>
              <p>
          ...
          <section className="build-software" id="transparent">
            <div id="build-software-1">
              <p>For Designers</p>
              <h3>Design Different</h3>
              <p>
          ...
          <section
            className="main-subsection-container-learning"
            id="Vivid-Tangelo"
          >
            <div className="section-image">
              <img
          ...
          <section className="main-subsection-container-learning fun" id="">
            <div>
              <img
                src={require("../../../Mobile Images/learning-fun.png")}
                alt={alt[0]}
              />
            </div>
            <div>
          ...
          <section className="experts">
            ...
            <div id="experts-1">
              <div className="experts-item">
                <img
                  src={require("../../../Mobile Images/Mobile - Learnable Home/IMG_4604@2x-400x359 1.png")}
                  alt={alt[0]}
                />
                <div>
                  <h6>Nnamdi</h6>
          ...
          <section
            className="main-subsection-container-learning fun"
            id="White-bg"
          >
            <div>
              <img
                src={require("../../../Mobile Images/classroom-group.png")}
                alt={alt[0]}
              />
            </div>
            <div>
          ...
          <section className="main-subsection-container-learning fun cadet">
            <div>
              <img
                src={require("../../../Mobile Images/Mobile - Learnable Home/Photo.png")}
                alt={alt[3]}
              />
            </div>
            <div>
          ...
          <section className="main-subsection-container-learning faq-section">
            <div id="faq">
              <h2>FAQ</h2>
              {faqButtons}
              <button>
          ...
          <section id="transparent">
            <div className="journal-section main-subsection-container-learning ">
              <h2>Journal</h2>

              <div id="journal-copy">
                <section className="journal-copy-copy">
                  <img
                    src={require("../../../Mobile Images/Mobile - Learnable Home/image 23.png")}
                    alt="expand"
                  />
                  {journalCopy}
                </section>
